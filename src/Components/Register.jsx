...
const Register = () => {
  return (
    ...
    >
        ...
        <p  className='text-center text-slate-400'>Register to explore!</p>
    </motion.div>
    <div className='flex justify-center mt-5'>
    <div className=' flex flex-col'>
    <div className='flex justify-inline m-2 '>
        <span className='text-4xl mt-3 mr-3 text-blue-500'><FaUser/></span>
        <Box
component="form"
sx={{
...
/></Box>
  ...
  Register
        ...
        <Link to='/'className='text-xs flex justify-center font-thin text-slate-400 '>have an account?<span className='cursor-pointer hover:text-blue-600'>Login</span></Link>
