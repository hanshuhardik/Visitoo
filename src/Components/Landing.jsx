...
<Carousel className="rounded-xl">
      <div className="relative h-full w-full">
        ...
        <div className="absolute inset-0 grid h-full w-full place-items-center bg-black/55">
          <div className="w-3/4 text-center md:w-2/4">
            ...
            >
              Visit the City <br/>Discover the Beauty of City
            </Typography>
            <Typography
              variant="lead"
              color="white"
            ...
            <Link to="/Login" className="flex justify-center gap-2">
      ...
      <div className="relative h-full w-full">
        <img
          ...
          alt="image 3"
          className=" flex justify-items-stretch h-full w-full object-cover"
        />
